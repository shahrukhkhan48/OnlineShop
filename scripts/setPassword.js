...
const userPoolId = 'us-east-1_N8nJLizXD';  // Replace with your User Pool ID
...
const region = 'us-east-1';  // Update this to the region where your Cognito User Pool is deployed
